...
STRINGS = {
    ...
    "en": {
        ...
        "menu_quit": "QUIT",
        "mods_popup_hint": "Custom mods are loaded from the mods/ folder",
    ...
    "ko": {
        ...
        "menu_settings": "설정",
        "menu_quit": "종료",
        "mods_popup_hint": "mods/ 폴더에서 커스텀 모드를 불러옵니다",
    ...
    "ja": {
        ...
        "menu_settings": "設定",
        "menu_quit": "終了",
        "mods_popup_hint": "カスタムMODはmods/フォルダから読み込まれます",
    ...
    "zh": {
        ...
        "menu_settings": "设置",
        "menu_quit": "退出",
        "mods_popup_hint": "自定义模组从 mods/ 文件夹加载",
        "quit_confirm": "确定退出游戏？",
        "yes": "是",
        "no": "否",
    ...
    "th": {
        ...
        "menu_quit": "ออก",
        "mods_popup_hint": "โหลดมอดจากโฟลเดอร์ mods/",
    ...
    "pt": {
        ...
        "menu_quit": "SAIR",
        "mods_popup_hint": "Mods personalizados são carregados da pasta mods/",
    ...
    "id": {
        ...
        "menu_quit": "KELUAR",
        "mods_popup_hint": "Mod kustom dimuat dari folder mods/",
    ...
    "es": {
        ...
        "menu_quit": "SALIR",
        "mods_popup_hint": "Los mods personalizados se cargan desde la carpeta mods/",
    ...
    "fr": {
        ...
        "menu_quit": "QUITTER",
        "mods_popup_hint": "Les mods personnalisés sont chargés depuis le dossier mods/",
    ...
    "it": {
        ...
        "menu_quit": "ESCI",
        "mods_popup_hint": "I mod personalizzati vengono caricati dalla cartella mods/",
    ...
    "de": {
        ...
        "menu_quit": "BEENDEN",
        "mods_popup_hint": "Eigene Mods werden aus dem Ordner mods/ geladen",

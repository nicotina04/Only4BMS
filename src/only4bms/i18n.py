...
STRINGS = {
    ...
    "ja": {
        ...
        'mp_waiting_opponent': '対戦相手を待機中...',
        'mp_press_enter_song': 'ENTERキーを押して曲を選択',
        'mp_waiting_host': 'ホストが曲を選ぶのを待っています...',
        'mp_fetching_songs': '曲リストを取得中...',
        'mp_choose_hint': '上下キーとENTERで選択',
        'mp_checking_diff': '難易度を確認中...',
        'mp_select_diff': '難易度を選択:',
        'mp_diff_hint': '上下キーで選択 | ENTERで決定 | ESCで戻る',
        'mp_downloading': 'アセットをダウンロード中...',
    ...
    "zh": {
        ...
        "course_clear_stats": "通关所有关卡！ | 总计: {total:,}",
        ...
        'mp_enter_server': '输入服务器地址:',
        'mp_connect_hint': '按 ENTER 键连接 (Esc 取消)',
        'mp_connecting': '正在连接到服务器{dots}',
        'mp_waiting_opponent': '等待对手加入...',
        'mp_press_enter_song': '按 ENTER 键选择歌曲',
        'mp_waiting_host': '等待房主选择歌曲...',
        'mp_fetching_songs': '正在获取歌曲列表...',
        'mp_choose_hint': '使用上下方向键和 ENTER 进行选择',
        'mp_checking_diff': '正在检查难度...',
        'mp_select_diff': '选择难度:',
        'mp_diff_hint': '上下方向键选择 | ENTER 确认 | ESC 返回',
        'mp_downloading': '正在下载资源...',
        'mp_download_prog': '{cur} / {tot} 个文件',
        'mp_ready_waiting': '准备就绪！等待服务器开始...',
        'mp_starting_in': '{rem} 秒后开始',
        'mp_host': '房主',
        'mp_guest': '客人',
        'mp_you': '你',
        'mp_player': '玩家',
    ...
    "th": {
        ...
        "course_clear":     "จบคอร์สสำเร็จ!",
        "failed_stamp":     "ไม่ผ่าน",
        "course_fail_hint": "กด ENTER / ESC เพื่อกลับ",
        "course_clear_stats": "เคลียร์ทุกด่านแล้ว! | รวม: {total:,}",
        ...
        'mp_enter_server': 'ป้อนที่อยู่เซิร์ฟเวอร์:',
        'mp_connect_hint': 'กด ENTER เพื่อเชื่อมต่อ (ESC เพื่อยกเลิก)',
        'mp_connecting': 'กำลังเชื่อมต่อกับเซิร์ฟเวอร์{dots}',
        'mp_waiting_opponent': 'กำลังรอคู่ต่อสู้...',
        'mp_press_enter_song': 'กด ENTER เพื่อเลือกเพลง',
        'mp_waiting_host': 'กำลังรอโฮสต์เลือกเพลง...',
        'mp_fetching_songs': 'กำลังดึงรายชื่อเพลง...',
        'mp_choose_hint': 'ใช้ปุ่ม ขึ้น/ลง และ ENTER เพื่อเลือก',
        'mp_checking_diff': 'กำลังตรวจสอบระดับความยาก...',
        'mp_select_diff': 'เลือกระดับความยาก:',
        'mp_diff_hint': 'ขึ้น/ลง เพื่อเลือก | ENTER ยืนยัน | ESC กลับ',
        'mp_downloading': 'กำลังดาวน์โหลดทรัพยากร...',
        'mp_download_prog': '{cur} / {tot} ไฟล์',
        'mp_ready_waiting': 'พร้อม! รอเซิร์ฟเวอร์เริ่มเกม...',
        'mp_starting_in': 'เริ่มใน {rem} วิ',
        'mp_host': 'โฮสต์',
        'mp_guest': 'ผู้มาเยือน',
        'mp_you': 'คุณ',
        'mp_player': 'ผู้เล่น',
    ...
    "pt": {
        ...
        "course_clear":     "CURSO CONCLUÍDO!",
        "failed_stamp":     "FALHOU",
        "course_fail_hint": "Pressione ENTER / ESC para voltar",
        "course_clear_stats": "Todas as etapas concluídas! | Total: {total:,}",
        ...
        'mp_enter_server': 'Digite o Endereço do Servidor:',
        'mp_connect_hint': 'Pressione ENTER para conectar (ESC cancelar)',
        'mp_connecting': 'Conectando ao servidor{dots}',
        'mp_waiting_opponent': 'Aguardando oponente...',
        'mp_press_enter_song': 'Pressione ENTER para Escolher Música',
        'mp_waiting_host': 'Aguardando Host escolher...',
        'mp_fetching_songs': 'Buscando músicas...',
        'mp_choose_hint': 'Use CIMA/BAIXO e ENTER para escolher',
        'mp_checking_diff': 'Verificando dificuldades...',
        'mp_select_diff': 'Selecione a Dificuldade:',
        'mp_diff_hint': 'CIMA/BAIXO escolher | ENTER confirmar | ESC voltar',
        'mp_downloading': 'Baixando Assets...',
        'mp_download_prog': '{cur} / {tot} arquivos',
        'mp_ready_waiting': 'Pronto! Aguardando o servidor iniciar...',
        'mp_starting_in': 'Iniciando em {rem}s',
        'mp_host': 'HOST',
        'mp_guest': 'CONVIDADO',
        'mp_you': 'Você',
        'mp_player': 'Jogador',
    ...
    "id": {
        ...
        "course_clear":     "KURSUS SELESAI!",
        "failed_stamp":     "GAGAL",
        "course_fail_hint": "Tekan ENTER / ESC untuk kembali",
        "course_clear_stats": "Semua tahap dibersihkan! | Total: {total:,}",
        ...
        'mp_enter_server': 'Masukkan Alamat Server:',
        'mp_connect_hint': 'Tekan ENTER untuk masuk (ESC batal)',
        'mp_connecting': 'Menghubungkan ke server{dots}',
        'mp_waiting_opponent': 'Menunggu lawan...',
        'mp_press_enter_song': 'Tekan ENTER untuk Pilih Lagu',
        'mp_waiting_host': 'Menunggu Host memilih lagu...',
        'mp_fetching_songs': 'Mengambil daftar lagu...',
        'mp_choose_hint': 'Gunakan ATAS/BAWAH dan ENTER untuk memilih',
        'mp_checking_diff': 'Memeriksa tingkat kesulitan...',
        'mp_select_diff': 'Pilih Kesulitan:',
        'mp_diff_hint': 'ATAS/BAWAH memilih | ENTER konfirmasi | ESC kembali',
        'mp_downloading': 'Mengunduh Aset...',
        'mp_download_prog': '{cur} / {tot} file',
        'mp_ready_waiting': 'Siap! Menunggu server memulai...',
        'mp_starting_in': 'Mulai dalam {rem}d',
        'mp_host': 'HOST',
        'mp_guest': 'TAMU',
        'mp_you': 'Kamu',
        'mp_player': 'Pemain',
    ...
    "es": {
        ...
        "course_clear":     "¡CURSO COMPLETADO!",
        "failed_stamp":     "FALLIDO",
        "course_fail_hint": "Presione ENTER / ESC para volver",
        "course_clear_stats": "¡Todas las etapas superadas! | Total: {total:,}",
        ...
        "course_back_hint": "[ESC] Voltar al Menu",
        ...
        'mp_enter_server': 'Ingresar dirección del servidor:',
        'mp_connect_hint': 'Presione ENTER para conectar (ESC para cancelar)',
        'mp_connecting': 'Conectando al servidor{dots}',
        'mp_waiting_opponent': 'Esperando al oponente...',
        'mp_press_enter_song': 'Presione ENTER para elegir canción',
        'mp_waiting_host': 'Esperando que el anfitrión elija...',
        'mp_fetching_songs': 'Obteniendo canciones...',
        'mp_choose_hint': 'Use ARRIBA/ABAJO y ENTER para elegir',
        'mp_checking_diff': 'Comprobando dificultades...',
        'mp_select_diff': 'Seleccionar Dificultad:',
        'mp_diff_hint': 'ARRIBA/ABAJO elegir | ENTER confirmar | ESC volver',
        'mp_downloading': 'Descargando archivos...',
        'mp_download_prog': '{cur} / {tot} archivos',
        'mp_ready_waiting': '¡Listo! Esperando a que el servidor comience...',
        'mp_starting_in': 'Comenzando en {rem}s',
        'mp_host': 'ANFITRIÓN',
        'mp_guest': 'INVITADO',
        'mp_you': 'Tú',
        'mp_player': 'Jugador',
    ...
    "fr": {
        ...
        "course_clear":     "COURS TERMINÉ !",
        "failed_stamp":     "ÉCHEC",
        "course_fail_hint": "Appuyez sur ENTRÉE / ÉCHAP pour revenir",
        "course_clear_stats": "Toutes les étapes franchies ! | Total : {total:,}",
        ...
        'mp_enter_server': 'Entrez ladresse du serveur:',
        'mp_connect_hint': 'Appuyez sur ENTRÉE pour connecter (Échap pour annuler)',
        'mp_connecting': 'Connexion au serveur{dots}',
        'mp_waiting_opponent': 'En attente dun adversaire...',
        'mp_press_enter_song': 'Appuyez sur ENTRÉE pour choisir une chanson',
        'mp_waiting_host': 'En attente du choix de lhôte...',
        'mp_fetching_songs': 'Récupération des chansons...',
        'mp_choose_hint': 'Utilisez HAUT/BAS et ENTRÉE pour choisir',
        'mp_checking_diff': 'Vérification des difficultés...',
        'mp_select_diff': 'Sélectionnez la difficulté:',
        'mp_diff_hint': 'HAUT/BAS sélectionner | ENTRÉE confirmer | ÉCHAP retour',
        'mp_downloading': 'Téléchargement des ressources...',
        'mp_download_prog': '{cur} / {tot} fichiers',
        'mp_ready_waiting': 'Prêt! En attente du début de la partie...',
        'mp_starting_in': 'Début dans {rem}s',
        'mp_host': 'HÔTE',
        'mp_guest': 'INVITÉ',
        'mp_you': 'Vous',
        'mp_player': 'Joueur',
    ...
    "it": {
        ...
        "course_clear":     "CORSO COMPLETATO!",
        "failed_stamp":     "FALLITO",
        "course_fail_hint": "Premi INVIO / ESC para tornare",
        "course_clear_stats": "Tutte le tappe superate! | Totale: {total:,}",
        ...
        'mp_enter_server': 'Inserisci l\'indirizzo del server:',
        'mp_connect_hint': 'Premi INVIO per connetterti (ESC per annullare)',
        'mp_connecting': 'Connessione al server in corso{dots}',
        'mp_waiting_opponent': 'In attesa dell\'avversario...',
        'mp_press_enter_song': 'Premi INVIO per Selezionare il Brano',
        'mp_waiting_host': 'In attesa dell\'Host...',
        'mp_fetching_songs': 'Recupero dei brani in corso...',
        'mp_choose_hint': 'Usa SU/GIÙ e INVIO per scegliere',
        'mp_checking_diff': 'Controllo delle difficoltà...',
        'mp_select_diff': 'Seleziona Difficoltà:',
        'mp_diff_hint': 'SU/GIÙ scegli | INVIO conferma | ESC indietro',
        'mp_downloading': 'Download degli asset...',
        'mp_download_prog': '{cur} / {tot} file',
        'mp_ready_waiting': 'Pronto! In attesa dell\'avvio del server...',
        'mp_starting_in': 'Inizio in {rem}s',
        'mp_host': 'HOST',
        'mp_guest': 'OSPITE',
        'mp_you': 'Tu',
        'mp_player': 'Giocatore',
    ...
    "de": {
        ...
        "course_clear":     "KURS ABGESCHLOSSEN!",
        "failed_stamp":     "FEHLGESCHLAGEN",
        "course_fail_hint": "ENTER / ESC zum Zurückkehren drücken",
        "course_clear_stats": "Alle Etappen geschafft! | Gesamt: {total:,}",
        ...
        'mp_enter_server': 'Serveradresse eingeben:',
        'mp_connect_hint': 'ENTER zum Verbinden (ESC zum Abbrechen)',
        'mp_connecting': 'Verbinde mit Server{dots}',
        'mp_waiting_opponent': 'Warte auf Gegner...',
        'mp_press_enter_song': 'ENTER drücken, um ein Lied auszuwählen',
        'mp_waiting_host': 'Warte auf Host...',
        'mp_fetching_songs': 'Lade Lieder...',
        'mp_choose_hint': 'Mit AUF/AB und ENTER auswählen',
        'mp_checking_diff': 'Prüfe Schwierigkeitsgrade...',
        'mp_select_diff': 'Schwierigkeit wählen:',
        'mp_diff_hint': 'AUF/AB wählen | ENTER bestätigen | ESC zurück',
        'mp_downloading': 'Lade Assets herunter...',
        'mp_download_prog': '{cur} / {tot} Dateien',
        'mp_ready_waiting': 'Bereit! Warte auf Server...',
        'mp_starting_in': 'Start in {rem}s',
        'mp_host': 'HOST',
        'mp_guest': 'GAST',
        'mp_you': 'Du',
        'mp_player': 'Spieler',
